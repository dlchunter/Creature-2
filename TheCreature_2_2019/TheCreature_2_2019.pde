...
float ballSize          = 50;
float eyeSize           = 5;
float zoomFactor        = 1.009;
float ballWalk; //Definerer ballWalk som en float
...
void draw() {                         
  ballWalk =  sin(ballX*1)*10;  //svingning på +10 til -10 pixels
  ballX         =  (ballX  +  speedX)*zoomFactor;    //flytter min bold 
  ballY         =  (ballY  +  speedY)*zoomFactor+ballWalk;    //Skifter koden til også at blive ganget med zoomFactoren, således at de går efter den.
